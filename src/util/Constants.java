...
public class Constants {
    ...
    public static final int CELL_WIDTH = (WINDOW_WIDTH - 2 * MARGIN_SIZE) / NUM_HORIZONTAL_INTERSECTIONS;
    public static final int CELL_HEIGHT = (WINDOW_HEIGHT - 2 * MARGIN_SIZE) / NUM_VERTICAL_INTERSECTIONS;
    public static final int SMALL_CIRCLE_HIT_BOX_DIAMETER = 40;
    public static final int SMALL_CIRCLE_RADIUS = 5;
    public static final int WALL_WIDTH = 2 * SMALL_CIRCLE_RADIUS + 2;
